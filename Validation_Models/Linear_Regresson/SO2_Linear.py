...
Original file is located at
    https://colab.research.google.com/drive/1BzU8g8TJdIWkVWztaNu39WA23cpESD7k
"""
...
pred1 = model.predict(X_val.reshape(-1, 1)).reshape(Y_val.shape)
pred = pred1[10].reshape((64,59))
print(pred.shape)
