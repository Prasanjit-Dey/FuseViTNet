...
Original file is located at
    https://colab.research.google.com/drive/19PB7vnjxS3oK5rzeOwdrAtGlPNMSNlgN
"""
...
def build_model(X_train):
    ...
    h = L.Conv2D(32, (3, 3), activation="relu")(h)
    out = L.Flatten()(h)
    out = L.Dense(50, activation="relu")(out)
    out = L.Dense(np.prod(X_train[0].shape), activation="relu")(out)
...
inp = X_val[0][:,:,0]
pred = model.predict(np.stack([X_val[0]]))[0].reshape((X_train[0].shape[0],X_train[0].shape[1]))
true = Y_val[0].reshape((X_train[0].shape[0],X_train[0].shape[1]))
print("X_val=",X_val.shape)
print("Input=",inp.shape)
print("Predict=",pred.shape)
print("True value=",true.shape)
