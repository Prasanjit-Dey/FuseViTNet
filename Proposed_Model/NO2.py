...
Original file is located at
    https://colab.research.google.com/drive/1z8IofzVut0h_4Gj41UVKJGL1kX_Huxra
"""
...
total_true = np.zeros((49, 67))
total_pred = np.zeros((49, 67))

# Loop through the weeks
for week in range(0, 7):
    # Extract data for the current week
    inp_week = X_val[week][:, :, 0]
    true_week = Y_val[week].reshape((49, 67))
    pred_week = val_outputs[week].reshape((49, 67))
    print(pred_week)
...
print(avg_pred)
# Now, avg_inp, avg_true, and avg_pred contain the average values over all weeks
